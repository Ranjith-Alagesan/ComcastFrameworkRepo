...
public class SearchAndDeleteProduct {
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		Select opt=new Select(driver.findElement(By.name("search_field")));
		opt.selectByVisibleText(searchIn);
		...
		String data = driver.findElement(By.xpath("//span[@class='genHeaderSmall'] ")).getText();
